...
<template>
    <div class="d-flex">
        ...
        <a-button key="submit" class="ms-auto" type="primary" @click="emit('onOK')">
            {{
                mode ? this.$root.translate('Save') : this.$root.translate('Add')
            }}
        </a-button>
    </div>
</template>
