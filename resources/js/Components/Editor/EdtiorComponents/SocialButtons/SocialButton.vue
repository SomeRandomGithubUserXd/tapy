    ...
    get: () => {
        ...
        switch (socialComponent.value.label) {
            ...
            case 'Telegram':
                ...
                break
            case 'SBER':
                href = `sms:900;?&body=Перевод%20${props.value} Nрублей`
                break
            case 'Copy':
                href = '#'
                break
...
<template>
    <div class="SocialNetworks-block" :class="props.view">
        <div class="SocialNetworks-block-network">
            <a v-if="socialComponent.label !== 'Copy'" @click="registerClick" class="Link only-icon" rel="noopener nofollow ugc" :href="href" target="_blank"
               :style="btnStyle">
