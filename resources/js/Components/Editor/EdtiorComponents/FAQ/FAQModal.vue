...
const removeFaq = (index) => {
    faqsModel.value.splice(index, 1)
}

watch(faqsModel.value, value => {}, {deep: true})
</script>
                    ...
                    <div class="ant-col ant-form-item-control">
                        <div class="ant-form-item-control-input">
                            <div class="ant-form-item-control-input-content">
                                <div v-for="(faq, index) in faqsModel" role="button" tabindex="0" aria-roledescription="sortable"
                                    ...
                                    <div class="SortablePanel" style="margin-bottom: 6px;">
                                        ...
                                        <div class="SortablePanel-content clickable">
                                            <div class="SortablePanel-title">{{ faq.question }}</div>
                                        </div>
                                        <div @click="removeFaq(index)" class="SortablePanel-button" v-if="faqsModel.length > 1">
                                            <button type="button"
