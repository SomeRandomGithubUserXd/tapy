...
import VideoGalleryCrudModal from "@/Components/Editor/EdtiorComponents/VideoGallery/VideoGalleryCrudModal.vue";
...
<template>
    <a-modal
        ...
        <video-gallery-crud-modal v-model="showCrudModal" @addFaq="addFaq"/>
                                        ...
                                        <div role="button" tabindex="0"
                                            ...
                                            <div class="SortablePanel" style="margin-bottom: 6px;">
                                                ...
                                                <div class="SortablePanel-content clickable">
                                                    <div class="SortablePanel-title">{{ element.url }}</div>
                                                </div>
