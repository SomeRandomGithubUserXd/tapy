...
<head>
    ...
    <title>qcd-service.com: сервис мультиссылок и микролендингов</title>
...
<main class="overflow-hidden">
            ...
            <div class="col pb-5 pb-md-0 check-view viewed">
                <div class="d-flex flex-column align-items-center mw-100 mx-auto step-1" style="width: 300px">
                    <div
                        ...
                        style="--duration: 1s">
                        <div class="text-muted">qcd-service.com/</div>
    ...
    <div class="py-8 bg-light">
        <div class="container" id="featured-3">
            ...
            <p class="pb-4">Популярные люди и бренды используют QCD в своих маркетинговых стратегиях</p>
        </div>
